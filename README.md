...
4. **Players** : Player들을 관리

5. **CardDeck** : 게임 전체 카드를 관리
    - 한 장의 카드를 덱에서 제거한다.
    - 현재 가지고 있는 카드를 출력한다.

6. **Cards** : 플레이어의 카드를 관리
    - 한 장의 카드를 추가한다.
    - 여러 장의 카드를 추가한다.
    - 한 장의 카드를 제거한다.
    - 여러 장의 카드를 제거한다.

7. **InputView** : Input을 처리하는 객체
...
1. 게임을 시작한다.
    - 플레이어 생성
    - 딜러 생성
2. 딜러는 플레이어에게 카드를 나눠준다. / 플레이어는 딜러로부터 카드를 받는다.
3. 각자 가지고 있는 카드를 출력한다.
