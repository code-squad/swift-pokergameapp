...
protocol Playable {
    ...
    func resetCard()
    func calcurateScore(of cards: [Card]) -> Score
    func straightLogic(maxCardScore: Dictionary<Card.Rank, Int>.Element, eachCardScore: [Card.Rank: Int]) -> Score
    func twoPairLogic(correctTwoPairs: [Card.Rank : Int]) -> Score
}
...
extension Playable {
    func calcurateScore(of cards: [Card]) -> Score {
        ...
        for card in cards {
            eachCardScore[card.rank, default: 0] += 1
        }
    ...
    public func twoPairLogic(correctTwoPairs: [Card.Rank : Int]) -> Score{
    ...
    public func straightLogic(maxCardScore: Dictionary<Card.Rank, Int>.Element, eachCardScore: [Card.Rank: Int]) -> Score {
